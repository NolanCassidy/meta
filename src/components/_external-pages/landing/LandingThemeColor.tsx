    ...
    <RootStyle>
      <Container maxWidth="lg" sx={{ position: 'relative', textAlign: 'center' }}>
        ...
        <Box sx={{ position: 'relative' }}>
          <Box component="img" src="/meta/static/home/theme-color/grid.png" />

          <Box sx={{ position: 'absolute', top: 0 }}>
            <MotionInView variants={varFadeInUp}>
              <img alt="screen" src={`/meta/static/home/theme-color/screen-${themeColor}.png`} />
            </MotionInView>
          </Box>
          ...
          <Box sx={{ position: 'absolute', top: 0 }}>
            <MotionInView variants={varFadeInDown}>
              ...
              >
                <img alt="sidebar" src={`/meta/static/home/theme-color/block1-${themeColor}.png`} />
              </motion.div>
            </MotionInView>
          </Box>
          ...
          <Box sx={{ position: 'absolute', top: 0 }}>
            <MotionInView variants={varFadeInDown}>
              <motion.div
                ...
                transition={{ duration: 8, repeat: Infinity }}
              >
                <img alt="sidebar" src={`/meta/static/home/theme-color/block2-${themeColor}.png`} />
              </motion.div>
            </MotionInView>
          </Box>
          ...
          <Box sx={{ position: 'absolute', top: 0 }}>
            <MotionInView variants={varFadeInDown}>
              ...
              >
                <img
                  alt="sidebar"
                  src={`/meta/static/home/theme-color/sidebar-${themeColor}.png`}
                />
              </motion.div>
            </MotionInView>
          </Box>
